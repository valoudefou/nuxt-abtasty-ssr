<template>
  ...
  :disabled="!product.inStock"
  @click="beginApplePay"
  class="flex items-center justify-center gap-2 w-full rounded-full bg-black text-white py-3 transition-all hover:bg-neutral-900 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed mt-4 shadow-md"
>
  <span aria-hidden="true" class="h-8 w-auto">
    <svg
