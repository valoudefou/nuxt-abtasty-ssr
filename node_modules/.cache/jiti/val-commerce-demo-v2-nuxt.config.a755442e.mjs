...
const extractRecommendationId = (input) => {
...
const withRecommendationFields = (endpoint) => {
  try {
...
false;var _default = exports.default =
...
defineNuxtConfig({
  ...
  vite: {
    resolve: {
      alias: {
        '#app-manifest': new URL('./utils/appManifestStub.ts', "file:///Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/nuxt.config.ts").pathname,
        ...
        '@react-native-async-storage/async-storage': new URL(
          './utils/asyncStorageShim.ts', "file:///Users/valerian.karsenty/Documents/App/val-commerce-demo-v2/nuxt.config.ts"
