...
vue_router = require_createDataLoader.__toESM(vue_router);
let unplugin_vue_router_data_loaders = require("unplugin-vue-router/data-loaders");
unplugin_vue_router_data_loaders = require_createDataLoader.__toESM(unplugin_vue_router_data_loaders);
let vue = require("vue");
vue = require_createDataLoader.__toESM(vue);
let __pinia_colada = require("@pinia/colada");
__pinia_colada = require_createDataLoader.__toESM(__pinia_colada);
