...
export {}
declare global {
  const DEFAULT_VENDOR_CLIENT: typeof import('../../utils/vendorsClient').DEFAULT_VENDOR_CLIENT
  ...
  const getSelectedVendorClient: typeof import('../../utils/vendorsClient').getSelectedVendorClient
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly DEFAULT_VENDOR_CLIENT: UnwrapRef<typeof import('../../utils/vendorsClient')['DEFAULT_VENDOR_CLIENT']>
    ...
    readonly getSelectedVendorClient: UnwrapRef<typeof import('../../utils/vendorsClient')['getSelectedVendorClient']>
